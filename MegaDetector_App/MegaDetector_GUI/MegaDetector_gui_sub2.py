    ...
    for subdir in os.listdir(base_image_folder):
        ...
        if os.path.isdir(subdir_path):
            ...
            commands = [
                ...
                f'{python_executable} "C:/Users/Public/Documents/MegaDetector_App/MegaDetector/megadetector/postprocessing/postprocess_batch_results.py" "{json_output_path}" "{subdir_output_path}" --image_base_dir "{subdir_path}" --num_images_to_sample -1'
            ]
